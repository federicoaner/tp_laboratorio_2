...
namespace Entidades
{
    public class Bateria : Instrumento
    {
        ...
        public Bateria(string tipo, string marca, string modelo, string estado, float precio)
        ...
        public Bateria(int id, string tipo, string marca, string modelo, string estado, float precio)
